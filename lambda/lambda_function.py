...
def create_html_email(
    ...
    <head>
        <style>
            ...
            .button {{ display: inline-block; background-color: #0066cc; color: white !important; padding: 15px 30px; text-decoration: none; border-radius: 5px; font-weight: bold; font-size: 16px; margin: 0; text-align: center; }}
    ...
    <body>
        <div class="container">
            ...
            <a href="{presigned_url}" class="button">Listen to the voicemail</a>
            {duration_text}
